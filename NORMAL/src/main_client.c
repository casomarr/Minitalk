...
/*   Updated: 2023/05/11 17:41:28 by casomarr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	signal_server.sa_handler = &signal_server_handler;
	if (sigaction(SIGUSR1, &signal_server, NULL) == -1 || \
	sigaction(SIGUSR2, &signal_server, NULL) == -1)
		return (EXIT_FAILURE);
